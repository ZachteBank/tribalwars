...
function createBlockElement() {
    ...
    $("#main_layout").after("<div id='fxutilitytimerblock' class='content-border'><table></table></div>")
...
function setAlarm(element, memo) {
    console.log(element, "element for alarm")
...
function initUiTimer(element, memo, key) {
    ...
    tmpTable.append("<tr><td>" + memo.name + ":</td><td><a title='" + memo.name + "' href='" + element.link + "' class='timer" + key + "'>timer</a></td></tr>")
